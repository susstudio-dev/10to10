...
const hoursTableDefault: DayHour[] = [
...
export function ContactPageClient({
  badge,
  subheading,
  faqs: contactFaqs = contactFaqsDefault,
  hoursTable = hoursTableDefault,
}: ContactPageProps) {
  const faqJsonLd = {
  ...
  return (
    <>
      ...
      <section className="relative pt-28 md:pt-32 pb-12 md:pb-16 overflow-hidden">
        <PageHeroBackdrop tintFrom="from-[#eafbfa]/85" objectPosition="center 60%" />
        ...
        <div className="container relative max-w-4xl text-center">
          <div className="flex items-center justify-center gap-3 flex-wrap">
            <span className="sticker">
              <MessageCircle className="h-3.5 w-3.5 text-brand-turquoise" /> {badge}
            </span>
            {status && (
              <motion.span
