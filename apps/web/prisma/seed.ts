...
import * as playschool from "../src/content/playschool";
import * as parties from "../src/content/parties";
import * as memberships from "../src/content/memberships";

const prisma = new PrismaClient();

function list(section: string, key: string, label: string, value: unknown) {
  return { section, key: `${section}.${key}`, label, type: "list", value: JSON.stringify(value) };
}

const items = [
  { section: "hero", key: "hero.badge", label: "Badge text", type: "text", value: "Open 10 AM – 10 PM · 7 days a week" },
  { section: "hero", key: "hero.heading_pre", label: "Heading — first part", type: "text", value: "Seven zones of" },
  { section: "hero", key: "hero.heading_emphasis", label: "Heading — highlighted word", type: "text", value: "play" },
  { section: "hero", key: "hero.heading_line2", label: "Heading — second line", type: "text", value: "one unforgettable day." },
  {
    section: "hero",
    key: "hero.subheading",
  ...
  // About page
  { section: "about", key: "about.badge", label: "Badge text", type: "text", value: "Our story" },
  { section: "about", key: "about.heading_pre", label: "Heading — first part", type: "text", value: "We built" },
  { section: "about", key: "about.heading_emphasis", label: "Heading — highlighted words", type: "text", value: "the playground" },
  { section: "about", key: "about.heading_post", label: "Heading — last part", type: "text", value: "we wished we had." },
  {
    section: "about",
    key: "about.subheading",
    label: "Subheading paragraph",
    type: "richtext",
    value:
  ...
  // Play School page
  { section: "play-school", key: "play-school.badge", label: "Badge text", type: "text", value: "Admissions open for 2026–27 · limited seats" },
  { section: "play-school", key: "play-school.heading_pre", label: "Heading — first part", type: "text", value: "Where curiosity" },
  { section: "play-school", key: "play-school.heading_emphasis", label: "Heading — highlighted words", type: "text", value: "beats curriculum" },
  {
    section: "play-school",
    key: "play-school.subheading",
    label: "Subheading paragraph",
    type: "richtext",
    value:
  ...
  // Summer Camp page
  { section: "summer-camp", key: "summer-camp.badge", label: "Badge text", type: "text", value: "Summer Camp 2027 · waitlist open" },
  { section: "summer-camp", key: "summer-camp.heading_pre", label: "Heading — first part", type: "text", value: "Where summer turns into" },
  { section: "summer-camp", key: "summer-camp.heading_emphasis", label: "Heading — highlighted word", type: "text", value: "unforgettable" },
  {
    section: "summer-camp",
    key: "summer-camp.subheading",
    label: "Subheading paragraph",
    type: "richtext",
    value:
  ...
  // Party Planner page
  { section: "party-planner", key: "party-planner.badge", label: "Badge text", type: "text", value: "Birthday parties & private events" },
  { section: "party-planner", key: "party-planner.heading_pre", label: "Heading — first part", type: "text", value: "Throw the party they'll" },
  { section: "party-planner", key: "party-planner.heading_emphasis", label: "Heading — highlighted words", type: "text", value: "never forget" },
  {
    section: "party-planner",
    key: "party-planner.subheading",
    label: "Subheading paragraph",
    type: "richtext",
    value:
  ...
  // Memberships page
  { section: "memberships", key: "memberships.badge", label: "Badge text", type: "text", value: "Memberships & passes" },
  { section: "memberships", key: "memberships.heading_pre", label: "Heading — first part", type: "text", value: "Pick your" },
  { section: "memberships", key: "memberships.heading_emphasis", label: "Heading — highlighted words", type: "text", value: "play plan" },
  {
    section: "memberships",
    key: "memberships.subheading",
    label: "Subheading paragraph",
    type: "richtext",
    value:
  ...
  // Contact page
  { section: "contact", key: "contact.badge", label: "Badge text", type: "text", value: "Get in touch" },
  {
    section: "contact",
